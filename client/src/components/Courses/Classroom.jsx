...
const Course = () => {
  ...
  useEffect(async () => {
    if (storeData.token){
      ...
      axios.post("http://localhost:5000/courses/getReminders", {
        ...
        .then(async (res)=>{
          ...
          for (let reminder of res.data) {
            await axios.post("http://localhost:5000/courses/getCourse", {
  ...
  const deleteClass = () => {
    axios.delete("http://localhost:5000/courses/deleteCourse", {
                  ...
                  <div className="content-box py-3 px-2 px-md-4 py-md-3 mb-3">
                    <h6 className="ms-1">Reminders</h6>
                    {
                      reminders.slice(0, (seeAll ? reminders.length : 3)).map((reminder, index) => {
                        ...
                        return (
                          <a key={reminder._id} href={"/courses/" + reminder.classCode + "/assignment/" + reminder._id}>
                            <div
