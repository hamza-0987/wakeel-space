  ...
  const RenderClasses = () => {
    ...
    return (  
      ((owned.concat(enrolled)).length == 0 ) ? (
        <div className="text-muted text-center">You haven't uploaded or accessed any resources.</div>
      ) : 
  ...
  const RenderClassesMobile = () => {
    return (
      ((activeTab=="1"?owned:enrolled).length == 0 ) ? (
        <div className="text-muted text-center">You haven't {(activeTab=="1"?"created":"joined")} any resources.</div>
      ) :  
